package hibernate._4_one_to_one.unidirectional_with_derived_identifier;
...
public class Example1 {
	...
	private static PostDetails getPostDetails(long postId) {
		...
		//post details can be fetched without an HQL cause
		//it has the same identifier as the parent post
		...
		*/
		...
		PostDetails details = session.find(PostDetails.class, postId);
