package spring_data.jpa.composite_key._2_using_embeded_id_annotation;
...
public class Example1 {
	...
	public CommandLineRunner data(ReviewRepository repository) {
		return (args) -> {
			// set up
			repository.save(new ReviewEntity(new ReviewEntityPK(1, 1), "marcus", null, "very good book"));
			repository.save(new ReviewEntity(new ReviewEntityPK(1, 2), "marcus", null, "very easy to understand"));
			repository.save(new ReviewEntity(new ReviewEntityPK(2, 1), "marcus", null, "highly recommended"));
			repository.save(new ReviewEntity(new ReviewEntityPK(2, 2), "marcus", null, "nice tutorials"));
...
/**
 * composite primary key class..it should follow the following rules:- 
 * 1- It must have a no-arg constructor. 
...
class ReviewEntity {
	...
	public ReviewEntity(ReviewEntityPK reviewEntityPK, String author, String subject, String content) {
	...
	public String toString() {
		StringBuilder builder = new StringBuilder();
		builder.append("ReviewEntity [reviewEntityPK=");
		builder.append(reviewEntityPK);
